...
class Student():
    def __init__(self,root):
        ...
        lbl_roll.grid(row=1,column=0,padx=10,pady=5,sticky="w")
        txt_roll = Entry(Manage_Frame,textvariable=self.Roll_No_var,font=("times new roman",15,"bold"),bd=5,relief=GROOVE)
        txt_roll.grid(row=1,column=1,padx=20,pady=5,sticky="w")
        ...
        txt_name.grid(row=2, column=1, padx=20, pady=5, sticky="w")
        ...
        txt_email.grid(row=3, column=1, padx=20, pady=5, sticky="w")

        lbl_gender = Label(Manage_Frame, text="Gender", bg="blue", fg="white", font=("times new roman", 20, "bold"))
        lbl_gender.grid(row=4, column=0, padx=10, pady=5, sticky="w")
        ...
        txt_contact.grid(row=5, column=1, padx=20, pady=5, sticky="w")

        lbl_dob = Label(Manage_Frame, text="D.O.B", bg="blue", fg="white", font=("times new roman", 20, "bold"))
        lbl_dob.grid(row=6, column=0, padx=10, pady=5, sticky="w")
        txt_dob = Entry(Manage_Frame,textvariable=self.dob_var, font=("times new roman", 15, "bold"), bd=5, relief=GROOVE)
        txt_dob.grid(row=6, column=1, padx=20, pady=5, sticky="w")
        ...
        self.txt_address = Text(Manage_Frame, width=20,height=4,font=("times new roman", 15, "bold"), bd=5, relief=GROOVE)
        ...
        Details_Frame.place(x=500, y=100, width=850, height=595)
